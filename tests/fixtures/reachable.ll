...
%program = type {%symbol_table, %btree_t_0, %btree_t_0, %btree_t_0, %btree_t_0, %btree_t_0, %btree_t_0, %btree_t_0, %btree_t_0, %btree_t_0}

@string_literal_0 = global [3 x i8] [i8 105, i8 111, i8 0]

@string_literal_1 = global [5 x i8] [i8 101, i8 100, i8 103, i8 101, i8 0]

@string_literal_2 = global [10 x i8] [i8 114, i8 101, i8 97, i8 99, i8 104, i8 97, i8 98, i8 108, i8 101, i8 0]

@string_literal_3 = global [9 x i8] [i8 101, i8 100, i8 103, i8 101, i8 95, i8 115, i8 116, i8 114, i8 0]

@string_literal_4 = global [14 x i8] [i8 114, i8 101, i8 97, i8 99, i8 104, i8 97, i8 98, i8 108, i8 101, i8 95, i8 115, i8 116, i8 114, i8 0]
...
start:
  ...
  %0 = call ccc ptr @malloc(i32 1704)
  ...
  call ccc void @eclair_btree_init_empty_0(ptr %10)
  %11 = getelementptr %program, ptr %0, i32 0, i32 0
  %12 = getelementptr inbounds [3 x i8], ptr @string_literal_0, i32 0, i32 0
  %13 = zext i32 2 to i64
  %14 = call ccc ptr @malloc(i32 2)
  call ccc void @llvm.memcpy.p0i8.p0i8.i64(ptr %14, ptr %12, i64 %13, i1 0)
  call ccc void @eclair_symbol_init(ptr %stack.ptr_0, i32 2, ptr %14)
  %15 = call ccc i32 @eclair_symbol_table_find_or_insert(ptr %11, ptr %stack.ptr_0)
  %16 = getelementptr %program, ptr %0, i32 0, i32 0
  %17 = getelementptr inbounds [5 x i8], ptr @string_literal_1, i32 0, i32 0
  %18 = zext i32 4 to i64
  %19 = call ccc ptr @malloc(i32 4)
  call ccc void @llvm.memcpy.p0i8.p0i8.i64(ptr %19, ptr %17, i64 %18, i1 0)
  call ccc void @eclair_symbol_init(ptr %stack.ptr_1, i32 4, ptr %19)
  %20 = call ccc i32 @eclair_symbol_table_find_or_insert(ptr %16, ptr %stack.ptr_1)
  %21 = getelementptr %program, ptr %0, i32 0, i32 0
  %22 = getelementptr inbounds [10 x i8], ptr @string_literal_2, i32 0, i32 0
  %23 = zext i32 9 to i64
  %24 = call ccc ptr @malloc(i32 9)
  call ccc void @llvm.memcpy.p0i8.p0i8.i64(ptr %24, ptr %22, i64 %23, i1 0)
  call ccc void @eclair_symbol_init(ptr %stack.ptr_2, i32 9, ptr %24)
  %25 = call ccc i32 @eclair_symbol_table_find_or_insert(ptr %21, ptr %stack.ptr_2)
  %26 = getelementptr %program, ptr %0, i32 0, i32 0
  %27 = getelementptr inbounds [9 x i8], ptr @string_literal_3, i32 0, i32 0
  %28 = zext i32 8 to i64
  %29 = call ccc ptr @malloc(i32 8)
  call ccc void @llvm.memcpy.p0i8.p0i8.i64(ptr %29, ptr %27, i64 %28, i1 0)
  call ccc void @eclair_symbol_init(ptr %stack.ptr_3, i32 8, ptr %29)
  %30 = call ccc i32 @eclair_symbol_table_find_or_insert(ptr %26, ptr %stack.ptr_3)
  %31 = getelementptr %program, ptr %0, i32 0, i32 0
  %32 = getelementptr inbounds [14 x i8], ptr @string_literal_4, i32 0, i32 0
  %33 = zext i32 13 to i64
  %34 = call ccc ptr @malloc(i32 13)
  call ccc void @llvm.memcpy.p0i8.p0i8.i64(ptr %34, ptr %32, i64 %33, i1 0)
  call ccc void @eclair_symbol_init(ptr %stack.ptr_4, i32 13, ptr %34)
  %35 = call ccc i32 @eclair_symbol_table_find_or_insert(ptr %31, ptr %stack.ptr_4)
  ret ptr %0
}
...
start:
  ...
  call ccc void @eclair_btree_destroy_0(ptr %9)
  call ccc void @free(ptr %arg_0)
  ret void
}

define external ccc void @eclair_btree_insert_range_delta_reachable_str_reachable_str(ptr %tree_0, ptr %begin_0, ptr %end_0) {
start:
  br label %while_begin_0
while_begin_0:
  %0 = call ccc i1 @eclair_btree_iterator_is_equal_0(ptr %begin_0, ptr %end_0)
...
define external ccc void @eclair_btree_insert_range_reachable_str_new_reachable_str(ptr %tree_0, ptr %begin_0, ptr %end_0) {
start:
  br label %while_begin_0
while_begin_0:
  %0 = call ccc i1 @eclair_btree_iterator_is_equal_0(ptr %begin_0, ptr %end_0)
...
start:
  ...
  %stack.ptr_22 = alloca %btree_iterator_t_0, i32 1
  ...
  %stack.ptr_30 = alloca [2 x i32], i32 1
  ...
  %stack.ptr_36 = alloca %btree_iterator_t_0, i32 1
...
end_if_0:
  ...
  %13 = load i32, ptr %12
  store i32 %13, ptr %11
  %14 = getelementptr %program, ptr %arg_0, i32 0, i32 9
  ...
  br label %loop_0
range_query.end:
  %16 = getelementptr %program, ptr %arg_0, i32 0, i32 9
  call ccc void @eclair_btree_begin_0(ptr %16, ptr %stack.ptr_5)
  %17 = getelementptr %program, ptr %arg_0, i32 0, i32 9
  call ccc void @eclair_btree_end_0(ptr %17, ptr %stack.ptr_6)
  %18 = getelementptr %program, ptr %arg_0, i32 0, i32 2
  call ccc void @eclair_btree_insert_range_delta_reachable_str_reachable_str(ptr %18, ptr %stack.ptr_5, ptr %stack.ptr_6)
  br label %loop_1
loop_1:
  %19 = getelementptr %program, ptr %arg_0, i32 0, i32 7
  ...
  %24 = getelementptr %program, ptr %arg_0, i32 0, i32 4
  call ccc void @eclair_btree_lower_bound_0(ptr %24, ptr %stack.ptr_7, ptr %stack.ptr_9)
  %25 = getelementptr %program, ptr %arg_0, i32 0, i32 4
...
end_if_2:
  ...
  %45 = load i32, ptr %44
  store i32 %45, ptr %43
  %46 = getelementptr %program, ptr %arg_0, i32 0, i32 9
...
if_3:
  ...
  %54 = load i32, ptr %53
  store i32 %54, ptr %52
  %55 = getelementptr %program, ptr %arg_0, i32 0, i32 7
...
range_query.end_2:
  ...
  br label %loop_2
range_query.end_1:
  %57 = getelementptr %program, ptr %arg_0, i32 0, i32 7
  %58 = call ccc i1 @eclair_btree_is_empty_0(ptr %57)
  br i1 %58, label %if_4, label %end_if_4
if_4:
  br label %loop.end
end_if_4:
  %59 = getelementptr %program, ptr %arg_0, i32 0, i32 7
  call ccc void @eclair_btree_begin_0(ptr %59, ptr %stack.ptr_17)
  %60 = getelementptr %program, ptr %arg_0, i32 0, i32 7
  call ccc void @eclair_btree_end_0(ptr %60, ptr %stack.ptr_18)
  %61 = getelementptr %program, ptr %arg_0, i32 0, i32 9
  call ccc void @eclair_btree_insert_range_reachable_str_new_reachable_str(ptr %61, ptr %stack.ptr_17, ptr %stack.ptr_18)
  %62 = getelementptr %program, ptr %arg_0, i32 0, i32 7
  %63 = getelementptr %program, ptr %arg_0, i32 0, i32 2
...
loop.end:
  ...
  %68 = getelementptr %program, ptr %arg_0, i32 0, i32 3
  call ccc void @eclair_btree_lower_bound_0(ptr %68, ptr %stack.ptr_19, ptr %stack.ptr_21)
  %69 = getelementptr %program, ptr %arg_0, i32 0, i32 3
  call ccc void @eclair_btree_upper_bound_0(ptr %69, ptr %stack.ptr_20, ptr %stack.ptr_22)
  br label %loop_4
loop_4:
  %70 = call ccc i1 @eclair_btree_iterator_is_equal_0(ptr %stack.ptr_21, ptr %stack.ptr_22)
  br i1 %70, label %if_5, label %end_if_5
if_5:
  br label %range_query.end_3
end_if_5:
  %71 = call ccc ptr @eclair_btree_iterator_current_0(ptr %stack.ptr_21)
  %72 = getelementptr [2 x i32], ptr %stack.ptr_23, i32 0, i32 0
  %73 = getelementptr [2 x i32], ptr %71, i32 0, i32 0
  %74 = load i32, ptr %73
  store i32 %74, ptr %72
  %75 = getelementptr [2 x i32], ptr %stack.ptr_23, i32 0, i32 1
  %76 = getelementptr [2 x i32], ptr %71, i32 0, i32 1
  %77 = load i32, ptr %76
  store i32 %77, ptr %75
  %78 = getelementptr %program, ptr %arg_0, i32 0, i32 8
  %79 = call ccc i1 @eclair_btree_insert_value_0(ptr %78, ptr %stack.ptr_23)
  call ccc void @eclair_btree_iterator_next_0(ptr %stack.ptr_21)
  br label %loop_4
range_query.end_3:
  %80 = getelementptr %program, ptr %arg_0, i32 0, i32 8
  call ccc void @eclair_btree_begin_0(ptr %80, ptr %stack.ptr_24)
  %81 = getelementptr %program, ptr %arg_0, i32 0, i32 8
  call ccc void @eclair_btree_end_0(ptr %81, ptr %stack.ptr_25)
  %82 = getelementptr %program, ptr %arg_0, i32 0, i32 1
  call ccc void @eclair_btree_insert_range_delta_reachable_reachable(ptr %82, ptr %stack.ptr_24, ptr %stack.ptr_25)
  br label %loop_5
loop_5:
  %83 = getelementptr %program, ptr %arg_0, i32 0, i32 6
  call ccc void @eclair_btree_clear_0(ptr %83)
  %84 = getelementptr [2 x i32], ptr %stack.ptr_26, i32 0, i32 0
  store i32 0, ptr %84
  %85 = getelementptr [2 x i32], ptr %stack.ptr_26, i32 0, i32 1
  store i32 0, ptr %85
  ...
  store i32 4294967295, ptr %87
  %88 = getelementptr %program, ptr %arg_0, i32 0, i32 3
  call ccc void @eclair_btree_lower_bound_0(ptr %88, ptr %stack.ptr_26, ptr %stack.ptr_28)
  %89 = getelementptr %program, ptr %arg_0, i32 0, i32 3
  call ccc void @eclair_btree_upper_bound_0(ptr %89, ptr %stack.ptr_27, ptr %stack.ptr_29)
  br label %loop_6
loop_6:
  %90 = call ccc i1 @eclair_btree_iterator_is_equal_0(ptr %stack.ptr_28, ptr %stack.ptr_29)
  br i1 %90, label %if_6, label %end_if_6
if_6:
  br label %range_query.end_4
end_if_6:
  %91 = call ccc ptr @eclair_btree_iterator_current_0(ptr %stack.ptr_28)
  %92 = getelementptr [2 x i32], ptr %stack.ptr_30, i32 0, i32 0
  %93 = getelementptr [2 x i32], ptr %91, i32 0, i32 1
  %94 = load i32, ptr %93
  store i32 %94, ptr %92
  %95 = getelementptr [2 x i32], ptr %stack.ptr_30, i32 0, i32 1
  store i32 0, ptr %95
  %96 = getelementptr [2 x i32], ptr %stack.ptr_31, i32 0, i32 0
  %97 = getelementptr [2 x i32], ptr %91, i32 0, i32 1
  %98 = load i32, ptr %97
  store i32 %98, ptr %96
  %99 = getelementptr [2 x i32], ptr %stack.ptr_31, i32 0, i32 1
  store i32 4294967295, ptr %99
  %100 = getelementptr %program, ptr %arg_0, i32 0, i32 1
  call ccc void @eclair_btree_lower_bound_0(ptr %100, ptr %stack.ptr_30, ptr %stack.ptr_32)
  %101 = getelementptr %program, ptr %arg_0, i32 0, i32 1
  call ccc void @eclair_btree_upper_bound_0(ptr %101, ptr %stack.ptr_31, ptr %stack.ptr_33)
  br label %loop_7
loop_7:
  %102 = call ccc i1 @eclair_btree_iterator_is_equal_0(ptr %stack.ptr_32, ptr %stack.ptr_33)
  br i1 %102, label %if_7, label %end_if_7
if_7:
  br label %range_query.end_5
end_if_7:
  %103 = call ccc ptr @eclair_btree_iterator_current_0(ptr %stack.ptr_32)
  %104 = getelementptr [2 x i32], ptr %stack.ptr_34, i32 0, i32 0
  %105 = getelementptr [2 x i32], ptr %91, i32 0, i32 0
  %106 = load i32, ptr %105
  store i32 %106, ptr %104
  %107 = getelementptr [2 x i32], ptr %stack.ptr_34, i32 0, i32 1
  %108 = getelementptr [2 x i32], ptr %103, i32 0, i32 1
  %109 = load i32, ptr %108
  store i32 %109, ptr %107
  %110 = getelementptr %program, ptr %arg_0, i32 0, i32 8
  %111 = call ccc i1 @eclair_btree_contains_0(ptr %110, ptr %stack.ptr_34)
  %112 = select i1 %111, i1 0, i1 1
  br i1 %112, label %if_8, label %end_if_8
if_8:
  %113 = getelementptr [2 x i32], ptr %stack.ptr_35, i32 0, i32 0
  %114 = getelementptr [2 x i32], ptr %91, i32 0, i32 0
  %115 = load i32, ptr %114
  store i32 %115, ptr %113
  %116 = getelementptr [2 x i32], ptr %stack.ptr_35, i32 0, i32 1
  %117 = getelementptr [2 x i32], ptr %103, i32 0, i32 1
  %118 = load i32, ptr %117
  store i32 %118, ptr %116
  %119 = getelementptr %program, ptr %arg_0, i32 0, i32 6
  %120 = call ccc i1 @eclair_btree_insert_value_0(ptr %119, ptr %stack.ptr_35)
  br label %end_if_8
end_if_8:
  call ccc void @eclair_btree_iterator_next_0(ptr %stack.ptr_32)
  br label %loop_7
range_query.end_5:
  call ccc void @eclair_btree_iterator_next_0(ptr %stack.ptr_28)
  br label %loop_6
range_query.end_4:
  %121 = getelementptr %program, ptr %arg_0, i32 0, i32 6
  %122 = call ccc i1 @eclair_btree_is_empty_0(ptr %121)
  br i1 %122, label %if_9, label %end_if_9
if_9:
  br label %loop.end_1
end_if_9:
  %123 = getelementptr %program, ptr %arg_0, i32 0, i32 6
  call ccc void @eclair_btree_begin_0(ptr %123, ptr %stack.ptr_36)
  %124 = getelementptr %program, ptr %arg_0, i32 0, i32 6
  call ccc void @eclair_btree_end_0(ptr %124, ptr %stack.ptr_37)
  %125 = getelementptr %program, ptr %arg_0, i32 0, i32 8
  call ccc void @eclair_btree_insert_range_reachable_new_reachable(ptr %125, ptr %stack.ptr_36, ptr %stack.ptr_37)
  %126 = getelementptr %program, ptr %arg_0, i32 0, i32 6
  %127 = getelementptr %program, ptr %arg_0, i32 0, i32 1
  call ccc void @eclair_btree_swap_0(ptr %126, ptr %127)
  br label %loop_5
loop.end_1:
  ret void
}
...
start:
  switch i32 %fact_type_0, label %switch.default_0 [i32 1, label %edge_0 i32 3, label %edge_str_0 i32 0, label %io_0]
edge_0:
  %0 = getelementptr %program, ptr %eclair_program_0, i32 0, i32 3
  br label %for_begin_0
for_begin_0:
...
for_end_0:
  br label %end_0
edge_str_0:
  %6 = getelementptr %program, ptr %eclair_program_0, i32 0, i32 4
  br label %for_begin_1
for_begin_1:
  %7 = phi i32 [0, %edge_str_0], [%11, %for_body_1]
  %8 = icmp ult i32 %7, %fact_count_0
  br i1 %8, label %for_body_1, label %for_end_1
for_body_1:
  %9 = getelementptr [2 x i32], ptr %memory_0, i32 %7
  %10 = call ccc i1 @eclair_btree_insert_value_0(ptr %6, ptr %9)
  %11 = add i32 1, %7
  br label %for_begin_1
for_end_1:
  br label %end_0
io_0:
  ...
  br label %for_begin_2
for_begin_2:
  %13 = phi i32 [0, %io_0], [%17, %for_body_2]
...
start:
  ...
  switch i32 %fact_type_0, label %switch.default_0 [i32 0, label %io_0 i32 2, label %reachable_0 i32 4, label %reachable_str_0]
io_0:
  %0 = getelementptr %program, ptr %eclair_program_0, i32 0, i32 5
...
while_end_0:
  ret ptr %4
reachable_0:
  %14 = getelementptr %program, ptr %eclair_program_0, i32 0, i32 8
  %15 = call ccc i64 @eclair_btree_size_0(ptr %14)
  %16 = trunc i64 %15 to i32
  %17 = mul i32 %16, 8
  %18 = call ccc ptr @malloc(i32 %17)
  store i32 0, ptr %stack.ptr_3
  call ccc void @eclair_btree_begin_0(ptr %14, ptr %stack.ptr_4)
  call ccc void @eclair_btree_end_0(ptr %14, ptr %stack.ptr_5)
  br label %while_begin_1
while_begin_1:
  %19 = call ccc i1 @eclair_btree_iterator_is_equal_0(ptr %stack.ptr_4, ptr %stack.ptr_5)
  %20 = select i1 %19, i1 0, i1 1
  br i1 %20, label %while_body_1, label %while_end_1
while_body_1:
  %21 = load i32, ptr %stack.ptr_3
  %22 = getelementptr [2 x i32], ptr %18, i32 %21
  %23 = call ccc ptr @eclair_btree_iterator_current_0(ptr %stack.ptr_4)
  %24 = getelementptr [2 x i32], ptr %23, i32 0
  %25 = load [2 x i32], ptr %24
  %26 = getelementptr [2 x i32], ptr %22, i32 0
  store [2 x i32] %25, ptr %26
  %27 = add i32 %21, 1
...
while_end_1:
  ret ptr %18
reachable_str_0:
  %28 = getelementptr %program, ptr %eclair_program_0, i32 0, i32 9
  %29 = call ccc i64 @eclair_btree_size_0(ptr %28)
  %30 = trunc i64 %29 to i32
  %31 = mul i32 %30, 8
  %32 = call ccc ptr @malloc(i32 %31)
  store i32 0, ptr %stack.ptr_6
  call ccc void @eclair_btree_begin_0(ptr %28, ptr %stack.ptr_7)
  call ccc void @eclair_btree_end_0(ptr %28, ptr %stack.ptr_8)
  br label %while_begin_2
while_begin_2:
  %33 = call ccc i1 @eclair_btree_iterator_is_equal_0(ptr %stack.ptr_7, ptr %stack.ptr_8)
  %34 = select i1 %33, i1 0, i1 1
  br i1 %34, label %while_body_2, label %while_end_2
while_body_2:
  %35 = load i32, ptr %stack.ptr_6
  %36 = getelementptr [2 x i32], ptr %32, i32 %35
  %37 = call ccc ptr @eclair_btree_iterator_current_0(ptr %stack.ptr_7)
  %38 = getelementptr [2 x i32], ptr %37, i32 0
  %39 = load [2 x i32], ptr %38
  %40 = getelementptr [2 x i32], ptr %36, i32 0
  store [2 x i32] %39, ptr %40
  %41 = add i32 %35, 1
...
io_0:
  ...
  ret i32 %2
reachable_0:
  %3 = getelementptr %program, ptr %eclair_program_0, i32 0, i32 8
  %4 = call ccc i64 @eclair_btree_size_0(ptr %3)
  %5 = trunc i64 %4 to i32
  ret i32 %5
reachable_str_0:
  %6 = getelementptr %program, ptr %eclair_program_0, i32 0, i32 9
  %7 = call ccc i64 @eclair_btree_size_0(ptr %6)
